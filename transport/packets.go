...
type packetBase struct {
	// Determines the total size of the packet, including the header.
	Length uint32
	// Identifies the type of packet.
	PacketType PacketType
}

// This packet is used immediately after the Command/Data TCP transport channel is established. It is sent by the
...
type InitCommandAckPacket struct {
	packetBase
	// A unique number generated by the Responder used to associate the TCP transport channels belonging to same PTP-IP
...
// This packet is used to transport PTP operation requests. PTP-IP Operation Request Packets are issued by the Initiator
// and are transported to the Responder device via the PTP-IP Command/Data transport channel. The direction of this
...
// This packet is used to transport PTP Events on the Event TCP connection. The events are used to inform the Initiator
